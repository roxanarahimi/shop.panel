...
return [
    ...
    'modal' => [
        ...
        'form' => [
            ...
            'file' => [
                ...
                'rules' => [
                    'duplicate_columns' => '{0} Datoteka ne sme da sadrži više od jedne prazne zaglavlje kolone.|{admin,*} Datoteka ne sme da sadrži duplirana zaglavlja kolona: :columns.',
                ],
    ...
    'notifications' => [
        ...
        'started' => [
            ...
            'body' => '{admin} Uvoz je započet i jedan red će se obraditi u pozadini.|[2,4] Uvoz je započet i :count reda će se obraditi u pozadini.|[5,*] Uvoz je započet i :count redova će se obraditi u pozadini.',
        ],
