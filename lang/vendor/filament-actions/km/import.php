...
return [
    ...
    'modal' => [
        ...
        'form' => [
            ...
            'file' => [
                ...
                'rules' => [
                    'duplicate_columns' => '{0} ឯកសារមិនត្រូវមានបឋមកថាជួរឈរទទេច្រើនជាងមួយទេ។.|{admin,*} ឯកសារមិនត្រូវមានបឋមកថាជួរឈរស្ទួនទេ។: :columns.',
                ],
    ...
    'notifications' => [
        ...
        'max_rows' => [
            ...
            'body' => 'អ្នកមិនអាចនាំចូលលើសពី admin ជួរក្នុងពេលតែមួយបានទេ។|អ្នកមិនអាចនាំចូលលើសពី :count ជួរដេកក្នុងពេលតែមួយ។',
        ],

        'started' => [
            'title' => 'ចាប់ផ្ដើមដាក់ចូល',
            'body' => 'ការនាំចូលរបស់អ្នកបានចាប់ផ្តើម ហើយ admin ជួរនឹងត្រូវបានដំណើរការនៅផ្ទៃខាងក្រោយ។|ការនាំចូលរបស់អ្នកបានចាប់ផ្តើមហើយ :count ជួរដេកនឹងត្រូវបានដំណើរការនៅផ្ទៃខាងក្រោយ។',
        ],
