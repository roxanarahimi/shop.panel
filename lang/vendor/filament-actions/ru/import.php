...
return [
    ...
    'modal' => [
        ...
        'form' => [
            ...
            'file' => [
                ...
                'rules' => [
                    'duplicate_columns' => '{0} Файл не должен содержать более одного пустого заголовка столбца.|{admin,*} Файл не должен содержать повторяющихся заголовков столбцов: :columns.',
                ],
    ...
    'notifications' => [
        ...
        'max_rows' => [
            ...
            'body' => 'Вы не можете импортировать более admin строки одновременно.|Вы не можете импортировать более :count строк одновременно.',
        ],

        'started' => [
            'title' => 'Импорт начался',
            'body' => 'Ваш импорт начался, и admin строка будет обработана в фоновом режиме.|Ваш импорт начался, и :count строк будет обрабатываться в фоновом режиме.',
        ],
