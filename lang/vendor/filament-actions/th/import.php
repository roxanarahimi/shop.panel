...
return [
    ...
    'notifications' => [
        ...
        'max_rows' => [
            ...
            'body' => 'ไม่สามารถนำเข้ามากกว่า admin แถวในครั้งเดียวได้|ไม่สามารถนำเข้ามากกว่า :count แถวในครั้งเดียวได้',
        ],

        'started' => [
            'title' => 'เริ่มต้นการนำเข้าข้อมูล',
            'body' => 'การนำเข้าได้เริ่มต้นแล้ว และ admin รายการจะถูกประมวลผลในเบื้องหลัง|การนำเข้าได้เริ่มต้นแล้ว และ :count รายการจะถูกประมวลผลในเบื้องหลัง',
        ],
