...
return [
    ...
    'modal' => [
        ...
        'form' => [
            ...
            'file' => [
                ...
                'rules' => [
                    'duplicate_columns' => '{0} فائل میں ایک سے زیادہ خالی کالم ہیڈر نہیں ہونے چاہئیں۔|{admin,*} فائل میں ایک جیسے کالم ہیڈر نہیں ہونے چاہئیں: :columns۔',
                ],
    ...
    'notifications' => [
        ...
        'max_rows' => [
            ...
            'body' => 'آپ ایک وقت میں صرف admin قطار امپورٹ کر سکتے ہیں۔|آپ ایک وقت میں زیادہ سے زیادہ :count قطاریں امپورٹ کر سکتے ہیں۔',
        ],

        'started' => [
            'title' => 'امپورٹ شروع ہوگئی ہے',
            'body' => 'آپ کی امپورٹ شروع ہوچکی ہے، اور admin قطار بیک گراؤنڈ میں پروسیس ہوگی۔|آپ کی امپورٹ شروع ہوچکی ہے، اور :count قطاریں بیک گراؤنڈ میں پروسیس ہوں گی۔',
        ],
