...
return [
    ...
    'modal' => [
        ...
        'form' => [
            ...
            'file' => [
                ...
                'rules' => [
                    'duplicate_columns' => '{0} Файл не повинен містити більше ніж один пустий заголовок стовпця.|{admin,*} Файл не повинен містити повторюваних заголовків стовпців: :columns.',
                ],
    ...
    'notifications' => [
        ...
        'max_rows' => [
            ...
            'body' => 'Ви не можете імпортувати більше admin рядка одночасно.|Ви не можете імпортувати більше :count рядків одночасно.',
        ],

        'started' => [
            'title' => 'Імпорт розпочався',
            'body' => 'Ваш імпорт розпочався, і admin рядок буде опрацьовано у фоновому режимі.|Ваш імпорт розпочався, і :count рядків буде опрацьовуватися у фоновому режимі.',
        ],
