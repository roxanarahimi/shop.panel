...
return [
    ...
    'modal' => [
        ...
        'form' => [
            ...
            'file' => [
                ...
                'rules' => [
                    'duplicate_columns' => '{0} فایل نباید بیش از یک ستون با هدر خالی داشته باشد.|{admin,*} فایل نباید شامل ستون‌های با هدر تکراری باشد: :columns.',
                ],
    ...
    'notifications' => [
        ...
        'max_rows' => [
            ...
            'body' => 'شما نمی توانید بیش از admin ردیف را به طور همزمان وارد کنید.|شما نمی توانید بیش از :count ردیف را در یک زمان وارد کنید.',
        ],

        'started' => [
            'title' => 'ایمپورت آغاز شد',
            'body' => 'ایمپورت شما شروع شده است و admin ردیف در پس‌زمینه پردازش می‌شود.|ایمپورت شما آغاز شده است و :count ردیف در پس‌زمینه پردازش می‌شوند.',
        ],
