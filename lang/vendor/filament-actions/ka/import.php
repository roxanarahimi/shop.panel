...
return [
    ...
    'modal' => [
        ...
        'form' => [
            ...
            'file' => [
                ...
                'rules' => [
                    'duplicate_columns' => '{0} ფაილში არ უნდა იყოს ერთზე მეტი ცარიელი სვეტი სათაურში.|{admin,*} ფაილში არ უნდა იყოს დუბლირებული სვეტის სათაურები: :columns.',
                ],
    ...
    'notifications' => [
        ...
        'started' => [
            ...
            'body' => 'იმპორტი დაიწყო და admin ჩანაწერი დამუშავდება სერვერზე.|იმპორტი დაიწყო და :count ჩანაწერი დამუშავდება სერვერზე.',
        ],
