...
return [
    ...
    'modal' => [
        ...
        'form' => [
            ...
            'file' => [
                ...
                'rules' => [
                    'duplicate_columns' => '{0} ֆայլը չպետք է պարունակի մեկից ավելի դատարկ սյունակի վերնագիր։ |{admin,*} ֆայլը չպետք է պարունակի կրկնօրինակ սյունակի :columns վերնագրեր։',
                ],
    ...
    'notifications' => [
        ...
        'max_rows' => [
            ...
            'body' => 'Դուք չեք կարող միաժամանակ ներմուծել ավելի քան admin տող։/ Դուք չեք կարող միաժամանակ ներմուծել ավելի քան :count տող։',
        ],

        'started' => [
            'title' => 'Ներմուծումը սկսվել է',
            'body' => 'Ձեր ներմուծումը սկսվել է, և admin տողը կմշակվի հետին պլանում։|Ձեր ներմուծումը սկսվել է, և :count տող կվերամշակվեն հետին պլանում։',
        ],
